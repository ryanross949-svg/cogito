...
oracle.html: AI Prompt Engineering & Agents (AI) - v7.0 (Master Template)
How to Build a New App
Copy prima.html or nash.html (v7.0 is the master template).
Update the STORAGE_KEY variable (e.g., fermi-v7).
...
Ensure the Theme Switcher CSS, HTML, and JS are included (copy from PRIMA v7.0).
Key Mechanics
